				  ...
				  unsigned int nr_blockgroups)
{
	...
	for (i = 0; i < nr_blockgroups; i++, bgs++, blockgroups++) {
		/*
		 * The only thing that may change is fs_flags and the
		 * writepointer. But we update everything here for consistency
		 * except for the zone mapping, as it points to our internal
