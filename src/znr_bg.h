...
enum znr_bg_flags {
	...
	/*
	 * Blockgroup has backing zone information mapped (Zoned block devices),
	 * valid only for the local context, as such, this must not be sent
	 * over th enetwork during blockgroup reports.
	 */
...
{
	return bg->fs_wp_sector >= bg->nr_sectors;
}
